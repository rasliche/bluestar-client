    ...
    <div class="border-2 rounded w-1/2 mx-auto text-center">
        ...
        <form>
            <div>
                ...
                <p class="text-red" v-if="!$v.name.required">this field is required</p>
            </div>
            <div>
                ...
                <p class="text-red" v-if="!$v.email.required">this field is required</p>
                <p class="text-red" v-if="!$v.email.minLength">Field must have at least {{ $v.email.$params.minLength.min }} characters.</p>
            </div>
            <div>
                ...
                <p class="text-red" v-if="!$v.password.required">this field is required</p>
                <p class="text-red" v-if="!$v.password.minLength">Field must have at least {{ $v.password.$params.minLength.min }} characters.</p>
            </div>
