  ...
  <article class="lesson w-5/6 mx-auto">
    ...
    <editor-menu-bar :editor="editor" class="mt-2">
      <div class="commands" slot-scope="{ commands, isActive }">
        <button
          :class="{ 'bg-red-light': isActive.bold() }"
          @click="commands.bold"
        >
          Bold
        </button>
        <button
          :class="{ 'bg-red-light': isActive.italic() }"
          @click="commands.italic"
        >
          Italic
        </button>
        <button
          :class="{ 'bg-red-light': isActive.heading() }"
    ...
    <button @click.prevent="logLesson" class="border-2 rounded border-blue">
      Log Lesson to Console
    </button>
  </article>
</template>
