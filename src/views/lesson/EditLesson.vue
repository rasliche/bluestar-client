<template>
  <main class="lesson">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <BaseInput label="Lesson Title" type="text" v-model="lesson.title"></BaseInput>
      <BaseInput label="Short Description" type="text" v-model="lesson.description"></BaseInput>
      ...
      <div class="flex justify-between">
        <div class="menubar flex justify-between">
          ...
          <button @click="showImagePrompt(commands.image)">
            <svg viewBox="0 0 24 24" class="w-4 h-4 fill-current icon-photo">
              ...
              <path class="secondary text-gray-700" d="M15.3 12.3a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1 .3.7v3a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-3a1 1 0 0 1 .3-.7l4-4a1 1 0 0 1 1.4 0l3.3 3.29 1.3-1.3z"></path>
            </svg>
          </button>
          <button @click="showIframePrompt(commands.iframe)">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4 fill-current icon-film">
              ...
              <path class="secondary text-gray-700" d="M9 5h6a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zm0 8h6a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1z"></path>
            </svg>
          </button>
...
import { PageHeading, ButtonBase, ButtonPrimary, ButtonSecondary, ButtonDanger, BaseInput, } from '@/components/BaseUI/'
